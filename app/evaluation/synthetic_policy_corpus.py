...
_DOCS: list[SyntheticDoc] = [
    SyntheticDoc(
        ...
        filename="员工手册.pdf",
        sections=[
            ("第一章 总则", "本手册适用于全体员工，是员工了解公司制度、行为规范与基本权利义务的总纲。"),
            (
                "第二章 考勤与假期",
                "员工请假需提前提交申请并走审批流程。年假天数按工龄核定，年假没休完可以顺延到次年3月31日。"
                "病假需要提供医院证明和诊断书，病假条交HR备案。事假能请多少天按考勤标准核定，事假扣工资，事假为无薪假。"
                "丧假针对直系亲属，需提交申请。哺乳假每天一小时，产后一年内适用。",
            ),
            (
                "第三章 试用期与转正",
    ...
    SyntheticDoc(
        ...
        sections=[
            ...
            (
                "第四章 病假事假丧假",
                "病假需要医院证明与诊断书。事假按天扣工资，属于无薪假。丧假针对直系亲属，天数按员工手册执行。",
            ),
            (
                "第五章 哺乳假",
    ...
    SyntheticDoc(
        ...
        sections=[
            ...
            (
                "第三章 迟到与旷工",
                "迟到按考勤标准扣款。迟到次数累计会触发警告。旷工指未请假擅自缺勤，将按处罚条例处理。",
            ),
            (
                "第四章 加班与调休",
    ...
    SyntheticDoc(
        ...
        sections=[
            ("第一章 总则", "本制度规范工资结构、发薪日期、社保公积金与奖金福利。"),
            (
                "第二章 工资与发薪",
                "工资于每月10号发放，遇节假日提前。工资条载明税前税后明细与扣除项。"
            ...
            (
                "第五章 年终奖与调薪",
                "年终奖与年度绩效考核结果挂钩发放。调薪与考核成绩挂钩，离职时未休年假按日薪折算补偿。",
            ),
            (
                "第六章 出差与报销",
    ...
    SyntheticDoc(
        ...
        filename="保密协议.pdf",
        sections=[
            ("第一条 协议效力", "保密协议经双方签署后具有法律效力，员工在职与离职后均负有保密义务。"),
