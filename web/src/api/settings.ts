...
export interface ProviderInfo{id:string;label?:string;name?:string;configured?:boolean;model?:string}
...
export const testProvider=()=>apiClient.request<{status:string;provider:string;provider_label?:string;model:string;response?:string;tokens?:number;error?:string}>('/api/settings/llm-provider/test')
