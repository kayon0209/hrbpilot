...
export function KnowledgeBasePage() {
  ...
  if (!hasMinimumRole(user?.role, 'hr_manager')) return <main className="page-stack"><header className="page-heading"><div><span className="eyebrow">KNOWLEDGE / INDEX</span><h1>知识库</h1><p>制度文件、索引任务与检索数据由 HR 经理或管理员维护。</p></div></header><PermissionNotice feature="知识库" requiredRole="HR 经理或管理员" /></main>
