...
function KnowledgeBaseManagerPage() {
  ...
  return <main className="page-stack"><header className="page-heading"><div><span className="eyebrow">知识管理</span><h1>知识库</h1><p>文件上传与索引是两个独立步骤；只有“索引完成”的文件能参与检索。</p></div></header>
